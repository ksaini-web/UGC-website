...
function Footer() {
  return (
    ...
    <div className=' text-white  font-light grid grid-cols-1 lg:grid-cols-3 '>
        ...
        <div className='mt-10 ml-10 p-5 grid grid-cols-1 lg:grid-cols-2'>
          ...
          <ul>
            ...
            <li><span className='text-orange-600 font-extrabold'> > </span> PG portal</li> </ul>
            </div>
          ...
          <ul>
           ...
           <li>University Grants Commission (UGC)</li>
            ...
            <li>Phone: 011-23604446, 011-23604200</li>
              ...
              <li className='p-2 gap-0 flex  font-black mb-10'> <button className='bg-white p-1 rounded-l-xl text-black '>Total Visitors </button> <button className='text-black bg-orange-500 p-1 rounded-r-xl border-2 border-white border-b-white border-r-white' > 234018363 </button></li>
    ...
    <div className='grid grid-cols-2 lg:grid-cols-5 gap-1.5 m-5 p-7 '>
      ...
      <div className='bg-white hover:cursor-pointer hover:border-2 hover:border-orange-500 flex justify-center z-30 shadow-2xs'><img src={footerimg2} alt="" className=''/></div>
